...
import subprocess
import os
from mysqlUtilities import mysqlUtilities, get_Ubuntu_code_name
...
# get_Ubuntu_code_name() 函数已从 mysqlUtilities 导入
# 使用动态读取 /etc/os-release 的实现，无需维护版本映射表
